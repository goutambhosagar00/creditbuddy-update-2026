...
export default function BlogHero() {
  return (
    <section className="relative bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-100 py-24 overflow-hidden">
      {/* BACKGROUND GLOW */}
      ...
      <div className="relative max-w-4xl mx-auto px-6 text-center">
        ...
        <motion.p
          ...
          className="text-gray-600 mt-4 text-sm md:text-base max-w-xl mx-auto"
        >
